function createNavbar() {
    ...
    // Auth/User Section HTML
    const authDesktopHTML = isLoggedIn
        ? `
    ...
    const authMobileHTML = isLoggedIn
        ? `
            <div id="mobile-user-menu" class="px-4 py-2 border-t border-[#e0ddd0] dark:border-[#2E2E2E] space-y-2">
                <a href="/pages/users/profile.html" class="nav-link-mobile w-full block px-4">Profile</a>
